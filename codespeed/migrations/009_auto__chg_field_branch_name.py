...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Branch.name'
        db.alter_column('codespeed_branch', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Changing field 'Branch.name'
        db.alter_column('codespeed_branch', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
